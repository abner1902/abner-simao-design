        ...
        {project.partnerUrl && (
          <section className="flex items-center justify-center w-full mt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 border-2 border-stone-400 text-stone-600 dark:text-stone-300 dark:border-stone-500 hover:bg-stone-700 hover:text-white font-gotham font-black px-12 py-6 rounded-full transition-all uppercase text-[11px] tracking-[0.25em]"
            >
              <ExternalLink size={20} />
