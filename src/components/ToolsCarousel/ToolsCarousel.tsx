...
export default function ToolsCarousel() {
  const tools = [
    { src: '/assets/images/logos/Illustrator.webp', alt: 'Adobe Illustrator' },
    { src: '/assets/images/logos/Photoshop.webp', alt: 'Adobe Photoshop' },
    { src: '/assets/images/logos/Indesign.webp', alt: 'Adobe InDesign' },
    { src: '/assets/images/logos/Premiere-pro-logo.webp', alt: 'Adobe Premiere Pro' },
    { src: '/assets/images/logos/After-effects-logo.webp', alt: 'Adobe After Effects' },
    { src: '/assets/images/logos/Figma-logo.webp', alt: 'Figma' },
    { src: '/assets/images/logos/vscode.webp', alt: 'VS Code' },
    { src: '/assets/images/logos/react-logotipo.webp', alt: 'React' },
    { src: '/assets/images/logos/next-logotipo.webp', alt: 'Next.js' },
    { src: '/assets/images/logos/tailwind-logo.webp', alt: 'Tailwind CSS' },
    { src: '/assets/images/logos/vercel-logotipo.webp', alt: 'Vercel' },
  ];
