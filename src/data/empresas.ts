...
export const empresasData: EmpresaProject[] = [
  {
    ...
    title: 'Design para E-commerce e Varejo',
     category: 'Design para E-commerce',
  ...
  },
  {
    ...
    category: 'Gestão de Marca & Audiovisual',
  ...
  id: 5,
  slug: 'evento-estande',
  title: 'Design para Eventos & Estandes',
  category: 'Graphic Design',

role: 'Diretor de Arte & Designer Gráfico',
stack: ['Illustrator', 'Photoshop'],
status: 'Design para Eventos & Comunicação Visual',
methodology: 'Design Editorial & Ambientação de Marca',
year: '2022',
